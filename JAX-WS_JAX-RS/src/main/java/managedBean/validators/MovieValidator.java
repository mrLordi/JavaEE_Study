...
public class MovieValidator implements Validator {
    ...
    public void init() {
        ...
        DirectorWSImpImplementationService directorWSImpImplementationService = new DirectorWSImpImplementationService();
    ...
    public void validate(FacesContext facesContext, UIComponent uiComponent, Object o) throws ValidatorException {
        ...
        if (parameter.equals("name")) {
            ...
            Description description = descriptionDAO.getDescriptionById(descriptionId);
            if (description == null) {
