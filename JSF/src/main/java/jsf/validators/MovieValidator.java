 ...
 */
@FacesValidator("validators.MovieValidator")
public class MovieValidator implements Validator {
    ...
    public void validate(FacesContext facesContext, UIComponent uiComponent, Object o) throws ValidatorException {
        ...
        if (parameter.equals("name")) {
            ...
            Description description = new DescriptionDAO().getById(descriptionId);
            if (description == null) {
            ...
            Director director = new DirectorDAO().getById(directorId);
            if (director == null) {
    ...
    private int  check(String parameter, String name) {
        ...
        try {
            ...
            LOGGER.warn("The wrong value of asdasd" + name + "!", e);
